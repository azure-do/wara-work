...
export const site = {
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: [
        "PowerApps / Power Automate / SharePoint 連携",
        "承認フロー自動化・業務時間削減",
      ],
    },
    {
    ...
    },
    {
      ...
      highlights: [
        "Vue.js / Nuxt.js・Vuex・REST 連携",
        "SSR・コンポーネント設計・パフォーマンス最適化",
      ],
    },
  ],
  worksTitle: "制作・開発実績",
